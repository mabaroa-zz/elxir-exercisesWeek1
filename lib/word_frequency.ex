defmodule WordFrequency do
	def main(args) do
		...
		IO.puts "Input File: #{options[:file]}"
		word_frequency_map = options[:file]
							|> File.stream!
							|> get_world_list_stream
							|> count_words
		IO.puts "Processing entries ..."
		write_to_file(word_frequency_map)
		IO.puts "File word_frequency.txt written !"	
	end	
    ...
    defp get_world_list_stream(file_stream) do
